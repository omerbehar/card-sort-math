...
| ID | Task | Agent/Owner | Est. Days | Dependencies | Acceptance Criteria | Status |
|----|------|-------------|-----------|-------------|--------------------|--------|
| S1-010 | **First-time tutorial**: guided Level 1 (coach the tap, explain stacks/discard), shown once (flag in save) | ux-designer + ui-programmer | 2 | S1-001 | New player sees coaching; completing once sets flag; skippable | **Done** (2026-06-09): TutorialLogic/TutorialState (core), CoachOverlay (view), main.gd wiring, SaveData.tutorial_seen. 32 tutorial tests (23 unit + 9 integration); full suite 150 green. Visual ACs (reduced-motion / colorblind / font-scale) pending manual QA |
